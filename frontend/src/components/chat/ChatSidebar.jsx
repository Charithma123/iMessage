        ...
        >
          {filteredConversations.length === 0 ? (
            <div className="flex flex-col items-center justify-center px-4 py-8 text-center">
              <p className="text-sm font-medium text-muted">No active chats yet</p>
              <p className="mt-1 text-xs text-muted/80 max-w-[200px]">
                Select someone from your contacts to start chatting!
              </p>
              <button
                type="button"
                onClick={() => setSidebarTab("users")}
                className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-accent px-3 py-1.5 text-xs font-semibold text-accent-foreground shadow-sm transition hover:opacity-90 cursor-pointer"
              >
